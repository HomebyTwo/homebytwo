...
CELERY_TASK_DEFAULT_QUEUE = get_env_variable("CELERY_TASK_DEFAULT_QUEUE", "")
CELERY_TASK_DEFAULT_EXCHANGE = get_env_variable("CELERY_TASK_DEFAULT_EXCHANGE", "")
CELERY_TASK_DEFAULT_ROUTING_KEY = get_env_variable("CELERY_TASK_DEFAULT_ROUTING_KEY", "")
