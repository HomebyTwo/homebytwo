...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "shapefile", type=str, help="Path to the shapefile to import. "
        )
        ...
        parser.add_argument(
            ...
            nargs="?",
            default=-1,
            help=("Limits the number of imported features. "),
        )
        ...
        parser.add_argument(
            ...
            dest="delete",
            default=False,
            help=("Deletes all existing SwissNAME3D places before the import. "),
        )
    ...
    def delete(self, interactive):
        ...
        if interactive:
            self.stdout.write("Deleting %d places from the Database" % (place_count))

            if not self.query_yes_no("Do you want to continue?", "no"):
                error_msg = "You have canceled the operation."
    ...
    def handle(self, *args, **options):
        ...
        if options["interactive"]:
            self.stdout.write("Saving %d places from %s" % (feature_count, shapefile))
